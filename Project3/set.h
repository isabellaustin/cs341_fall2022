 ...
 * @class Set
 *
 * The Set class represents the mathematical concept of a set, where the universe 
of items corresponds
 * to a BitArray within the class. The presence of a 1 in the given index indicates
that the number is
 * is a member of the set - if the value is 0, the number is not a member of the 
set.
 */
class Set {
    public:
